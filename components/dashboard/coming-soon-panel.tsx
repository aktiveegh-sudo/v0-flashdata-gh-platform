  ...
  return (
    <Card className="overflow-hidden border-amber-400/20 bg-white shadow-sm dark:bg-[#0a110d]">
      <CardContent className="relative p-8 text-center sm:p-12">
        ...
        <div className="pointer-events-none absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-emerald-400/10 blur-3xl" />
        ...
        <p className="relative mx-auto mt-3 max-w-xl text-sm leading-7 text-gray-500 dark:text-white/60">{description}</p>
