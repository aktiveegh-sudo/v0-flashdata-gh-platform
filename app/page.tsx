...
import { Eye, EyeOff, Phone, Mail, User, Lock, ArrowRight, Sparkles, ShieldCheck, Globe, Zap, BadgeCheck, Star } from 'lucide-react'
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
              ...
              <div className="border-t border-white/10 bg-white/5 px-6 py-4 sm:px-8">
                <p className="text-center text-xs leading-5 text-white/45 sm:text-sm">
                  ...
                  <button className="font-medium text-amber-200 transition hover:text-amber-100 hover:underline">Terms of Service</button>
                  {' '}and{' '}
                  <button className="font-medium text-amber-200 transition hover:text-amber-100 hover:underline">Privacy Policy</button>
                </p>
              </div>
            </div>
          </div>
